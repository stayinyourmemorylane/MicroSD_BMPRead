...
void SSD1289_SendCommand(int command_address, int command_data){
	...
	CLEARBIT(SSD_1289_DA_PORT, SSD_1289_RS); // Pull RS back down to low default state
...
void SSD1289_Initalize(){
	...
	SSD_1289_RCW_PORT &= (0 << SSD_1289_RS) | (0 << SSD_1289_WR) | (1 << SSD_1289_RESET); 
	
	SSD_1289_LB_PORT &= 0x00;
	SSD_1289_HB_PORT &= 0x00;
